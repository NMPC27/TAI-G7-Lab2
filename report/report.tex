...
\begin{itemize}
    ...
    % TODO: these images contain bugs and are outdated
    \begin{figure}
        \centering
...
% TODO: talk about experimental method: how and which target texts were used and evaluted?
...
% we combined the previous target files to a single file named \textit{all\_languages.txt} and used it as a target text, and also used a small target text called \textit{dog.txt}
...
it will also detect the last chunk of text as French, which is wrong, the last chunk of text in the file is Chinese. % TODO: what is the "lowest entropy point"? What does the "the last chunk of text in the file is Chinese" part mean?
...
When increasing $k$, this difference becomes even more clear, as seen in figures \ref{fig:all_languages_p_c:1:3} and \ref{fig:all_languages_p_c:1:6}, % TODO: is it 3 and 6 or 6 and 9?
...
One of the positives of this approach is that we can identify much more easily an unknown language (languages that are not in the references) than in some of the previous approaches. % TODO: we can???
...
show information values which are slightly higher when observing the minimum information values, corresponding to the predicted language for the section. % TODO: what does this mean?
...
This happens because the model has more chances to hit the correct language, since the target is bigger. % TODO: how so?
